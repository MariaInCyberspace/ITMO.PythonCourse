...
def read_zip_all():
    """
    This function returns a list of parsed zip-code information read from 'zip_codes_states.csv' file
        pertinent to each city in this .csv file.

    Parameters: no parameters

    :return:
    list: A list of specific information about each city in 'zip_codes_states.csv' file.
     Each entry in the list returned contains another list of these elements:

...
Введите первый почтовый индекс => 123001
123001
Введите второй почтовый индекс => 101000
101000
Расстояние между 123001 и 101000 составляет 5.43 километров

Команды ('район', 'индекс', 'расстояние', 'финиш', 'яз') =>
